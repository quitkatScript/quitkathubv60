                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Quitkat Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Window = Fluent:CreateWindow({
    Title = " Quitkat Hub | Blox Fruits",
    SubTitle = "By : Beto0123",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://108048244373485" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://93289483066049" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://118099079870059" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://109200929992589" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://135808304471057" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://104152995293075" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://115753266770277" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://88316433426034" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://125363228874950" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "85048348336758" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://123575327539728",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("Quitkat Hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Quitkat Hub Discord Server",
        Description = "Suporte aqui",
        Callback = function()
        setclipboard("https://discord.gg/wFVFtSdT")
        end
        })
...
OrionLib:MakeNotification(
    {
        Name = "Notification",
        Content = "Pronto. vc pode usar o script agr",
...
Fluent:Notify({
    Title = "Quitkat Hub",
    Content = "Obg por usar Quitkat Hub",
    Duration = 8
})
